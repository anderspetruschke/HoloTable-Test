...
[CreateAssetMenu(fileName = "HoloDeviceConfig", menuName = "AxiomHoloDevice/CreateDeviceConfig", order = 1)]
public class HoloConfig : ScriptableObject
{
  ...
  [Tooltip("Connect to the VRPN server over TCP instead of UDP. This may be required if there is a NAT layer between you and the target server.")]
  public bool VRPNOverTCP = false;
